...
/**
 * @dev Implementation of the {IERC777} interface with a custom `_ERC1820_REGISTRY`.
 *
...
contract ERC777 is Context, IERC777, IERC20 {
    ...
    constructor(
        ...
        IERC1820Registry erc1820registry_,
        address[] memory defaultOperators_
    ) {
        _name = name_;
        _symbol = symbol_;
        _ERC1820_REGISTRY = erc1820registry_;
...
contract ERC777Mock is ERC777 {
    ...
    ) ERC777(_name, _symbol, _erc1820registry, new address[](0)) {}
        ...
        returns (bool)
    {
        address owner = _msgSender();
        uint256 currentAllowance = allowance(owner, spender);
        require(currentAllowance >= subtractedValue, "ERC777: decreased allowance below zero");
        unchecked {
    ...
    function setERC1820Registry(IERC1820Registry __ERC1820_REGISTRY) external {
        _ERC1820_REGISTRY = __ERC1820_REGISTRY;
